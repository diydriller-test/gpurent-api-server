...
USERS: list[dict] = [
    {"email": "kohsangbaek@naver.com", "username": "고성백", "subscriptions": [("이미지를 문장으로 변환(Image-to-Text)", 240_000)]},
    {"email": "osyang45@naver.com", "username": "망오석", "subscriptions": [("대규모 언어 모델(LLM)", 450_000)]},
    {"email": "goodye2001@naver.com", "username": "해피아이", "subscriptions": [("목소리 복제(Voice Clone)", 90_000)]},
    {"email": "namyeogi@naver.com", "username": "남쪽작가", "subscriptions": [("음성을 텍스트로 변환(STT)", 90_000)]},
    {"email": "goldenboyhhd21@gmail.com", "username": "goldenboy", "subscriptions": [
        ("음성을 텍스트로 변환(STT)", 90_000), ("텍스트를 음성으로 변환(TTS)", 90_000), ("대규모 언어 모델(LLM)", 450_000),
    ]},
    ...
    {"email": "fsxking77@naver.com", "username": "매트님", "subscriptions": [
        ("텍스트 임베딩(Embedding)", 60_000), ("대규모 언어 모델(LLM)", 450_000),
    ]},
    {"email": "kimdan2@nate.com", "username": "미즈하시", "subscriptions": [("이미지를 문장으로 변환(Image-to-Text)", 240_000)]},
    {"email": "dlwhdan1399@naver.com", "username": "서버서", "subscriptions": [("텍스트를 음성으로 변환(TTS)", 90_000)]},
    {"email": "magic_eia@kakao.com", "username": "슬래시", "subscriptions": [
        ("음성을 텍스트로 변환(STT)", 90_000), ("텍스트 임베딩(Embedding)", 60_000),
    ]},
    {"email": "dongmin7575@naver.com", "username": "윤동민", "subscriptions": [
        ("음성을 텍스트로 변환(STT)", 90_000), ("텍스트를 음성으로 변환(TTS)", 90_000),
    ]},
    {"email": "lsupertopl@naver.com", "username": "프로슈머", "subscriptions": [("대규모 언어 모델(LLM)", 450_000)]},
    {"email": "illustrated@kakao.com", "username": "아이보리15", "subscriptions": [("음성을 텍스트로 변환(STT)", 90_000)]},
    {"email": "dudhksl@naver.com", "username": "유연아", "subscriptions": [("대규모 언어 모델(LLM)", 450_000)]},
    {"email": "xpxren@gmail.com", "username": "엑시", "subscriptions": [("음성을 텍스트로 변환(STT)", 90_000)]},
    {"email": "dlaxpals1106@naver.com", "username": "엄마민", "subscriptions": [("음성을 텍스트로 변환(STT)", 90_000)]},
    {"email": "umtelex@naver.com", "username": "aidbwiki", "subscriptions": [
        ("대규모 언어 모델(LLM)", 450_000), ("텍스트 임베딩(Embedding)", 60_000), ("문장 재순위(Reranking)", 90_000),
    ]},
    {"email": "casex@naver.com", "username": "crossover_moon", "subscriptions": [("텍스트를 음성으로 변환(TTS)", 90_000)]},
    {"email": "sooneeally@kakao.com", "username": "강은순", "subscriptions": [("대규모 언어 모델(LLM)", 450_000)]},
    {"email": "wonjung815@naver.com", "username": "팽이풍이", "subscriptions": [
        ("음성을 텍스트로 변환(STT)", 90_000), ("텍스트를 음성으로 변환(TTS)", 90_000),
        ("목소리 복제(Voice Clone)", 90_000), ("텍스트를 음악으로 변환(Text-to-Music)", 180_000),
    ]},
    {"email": "chulojssung@naver.com", "username": "pjssung", "subscriptions": [("음성을 텍스트로 변환(STT)", 90_000)]},
    {"email": "talkingo@hotmail.com", "username": "고은석", "subscriptions": [("대규모 언어 모델(LLM)", 450_000)]},
    {"email": "celina0822@naver.com", "username": "뽀얀기", "subscriptions": [("음성을 텍스트로 변환(STT)", 90_000)]},
    {"email": "temp131133@naver.com", "username": "로우픽", "subscriptions": [("이미지 생성(Image Generation)", 300_000)]},
    {"email": "wlghtnw@nate.com", "username": "민지후", "subscriptions": [("대규모 언어 모델(LLM)", 450_000)]},
    {"email": "kmlim115@naver.com", "username": "without_임규빈", "subscriptions": [("음성을 텍스트로 변환(STT)", 90_000)]},
    {"email": "dudgjs4248@naver.com", "username": "김영인", "subscriptions": [("이미지를 문장으로 변환(Image-to-Text)", 240_000)]},
    {"email": "kunwon220@naver.com", "username": "매누룬", "subscriptions": [("음성을 텍스트로 변환(STT)", 90_000)]},
    {"email": "ykpark68@gmail.com", "username": "빈야자씨", "subscriptions": [("음성을 텍스트로 변환(STT)", 90_000)]},
    {"email": "luke7574@naver.com", "username": "박유호", "subscriptions": [
        ("텍스트 임베딩(Embedding)", 60_000), ("텍스트를 음성으로 변환(TTS)", 90_000),
    ]},
    {"email": "luke7571@naver.com", "username": "박유호", "subscriptions": [("음성을 텍스트로 변환(STT)", 90_000)]},
    {"email": "gkrdmlwhd10@nate.com", "username": "sentia", "subscriptions": [("음성을 텍스트로 변환(STT)", 90_000)]},
    {"email": "klsj2468@gmail.com", "username": "예봉", "subscriptions": [
        ("음성을 텍스트로 변환(STT)", 90_000), ("텍스트 임베딩(Embedding)", 60_000), ("문장 재순위(Reranking)", 90_000),
    ]},
    {"email": "cinnamonflavor@kakao.com", "username": "cinnamon", "subscriptions": [("음성을 텍스트로 변환(STT)", 90_000)]},
    {"email": "lsssh07@naver.com", "username": "ophthson", "subscriptions": [("음성을 텍스트로 변환(STT)", 90_000)]},
    {"email": "khy9941@hanmail.net", "username": "sotera", "subscriptions": [
        ("음성을 텍스트로 변환(STT)", 90_000), ("텍스트를 음성으로 변환(TTS)", 90_000),
    ]},
    {"email": "tak1933@hanmail.net", "username": "김.인.덕", "subscriptions": [("대규모 언어 모델(LLM)", 450_000)]},
    {"email": "whdktn3300@naver.com", "username": "김승균", "subscriptions": [("이미지 생성(Image Generation)", 300_000)]},
    {"email": "ckstn9896@hanmail.net", "username": "김현수", "subscriptions": [("텍스트 임베딩(Embedding)", 60_000)]},
    {"email": "yeon97@gmail.com", "username": "말랑", "subscriptions": [("음성을 텍스트로 변환(STT)", 90_000)]},
    {"email": "chenjingjun89@gmail.com", "username": "진경군", "subscriptions": [("대규모 언어 모델(LLM)", 450_000)]},
    {"email": "joeeun0614@gmail.com", "username": "드리블리", "subscriptions": [("음성을 텍스트로 변환(STT)", 90_000)]},
    {"email": "7101ehdus@naver.com", "username": "푸르코", "subscriptions": [
        ("텍스트 임베딩(Embedding)", 60_000), ("문장 재순위(Reranking)", 90_000),
    ]},
    {"email": "josh.hwang1@gmail.com", "username": "황상인파이팅", "subscriptions": [("음성을 텍스트로 변환(STT)", 90_000)]},
    {"email": "mmtsd@naver.com", "username": "티로패스", "subscriptions": [("대규모 언어 모델(LLM)", 450_000)]},
    {"email": "justpis@naver.com", "username": "damien", "subscriptions": [("음성을 텍스트로 변환(STT)", 90_000)]},
    {"email": "kimyeongseok@kakao.com", "username": "와즈인", "subscriptions": [
        ("텍스트 임베딩(Embedding)", 60_000), ("문장 재순위(Reranking)", 90_000),
    ]},
    {"email": "multi618@gmail.com", "username": "시중", "subscriptions": [
        ("음성을 텍스트로 변환(STT)", 90_000), ("대규모 언어 모델(LLM)", 450_000),
    ]},
    {"email": "cat4510@kakao.com", "username": "로보메카펫", "subscriptions": [("대규모 언어 모델(LLM)", 450_000)]},
    ...
    {"email": "k0809s@gmail.com", "username": "luke4", "subscriptions": [
        ("목소리 복제(Voice Clone)", 90_000), ("이미지를 문장으로 변환(Image-to-Text)", 240_000),
    ]},
    {"email": "cantstop@hoseo.edu", "username": "cantstop", "subscriptions": [("음성을 텍스트로 변환(STT)", 90_000)]},
    {"email": "ahyean0726@naver.com", "username": "김재원", "subscriptions": [
        ("텍스트를 음성으로 변환(TTS)", 90_000), ("텍스트를 음악으로 변환(Text-to-Music)", 180_000),
    ]},
    {"email": "soosoo6@naver.com", "username": "델루투스", "subscriptions": [
        ("음성을 텍스트로 변환(STT)", 90_000), ("텍스트를 음성으로 변환(TTS)", 90_000),
    ]},
    {"email": "l5soo@naver.com", "username": "수진명", "subscriptions": [("음성을 텍스트로 변환(STT)", 90_000)]},
    ...
    {"email": "aou8908@gmail.com", "username": "훈대표", "subscriptions": [("음성을 텍스트로 변환(STT)", 90_000)]},
]
